...
```ts
import { expr, serialize } from "@treequel/core";
...
[querying guide](https://phenx.github.io/Treequel/guide/getting-started).
...
The [Applications](https://phenx.github.io/Treequel/guide/applications) page is the full catalog.
...
| [`@treequel/core`](packages/core) | `Expr`, visitor/rewriter, `evaluate`, partial evaluation, printer, `b` builders | `tree` |
...
| [`@treequel/ts-transformer`](packages/ts-transformer) | TypeScript-compiler transformer for `tsc`-only builds | `transform` |
...
the concepts in [The C# lineage](https://phenx.github.io/Treequel/guide/lineage) and place Treequel next to ORMs,
query builders, and rules engines in
[Compared to ORMs & rules engines](https://phenx.github.io/Treequel/guide/comparison).
